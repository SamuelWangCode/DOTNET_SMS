...
typedef struct _SMSCOM_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } SMSCOM_MIDL_TYPE_FORMAT_STRING;

typedef struct _SMSCOM_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } SMSCOM_MIDL_PROC_FORMAT_STRING;

typedef struct _SMSCOM_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } SMSCOM_MIDL_EXPR_FORMAT_STRING;
...
extern const SMSCOM_MIDL_TYPE_FORMAT_STRING SMSCOM__MIDL_TypeFormatString;
extern const SMSCOM_MIDL_PROC_FORMAT_STRING SMSCOM__MIDL_ProcFormatString;
extern const SMSCOM_MIDL_EXPR_FORMAT_STRING SMSCOM__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IFirstObject_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IFirstObject_ProxyInfo;
...
static const SMSCOM_MIDL_PROC_FORMAT_STRING SMSCOM__MIDL_ProcFormatString =
    {
        0,
        {
...
static const SMSCOM_MIDL_TYPE_FORMAT_STRING SMSCOM__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* 1226 */	NdrFcShort( 0xfdc6 ),	/* Offset= -570 (656) */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    SMSCOM__MIDL_ProcFormatString.Format,
...
/* Object interface: IFirstObject, ver. 0.0,
   GUID={0x82a55a6d,0x1422,0x45c9,{0x88,0xc5,0xd0,0xdc,0x92,0x93,0x7f,0x66}} */

#pragma code_seg(".orpc")
static const unsigned short IFirstObject_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IFirstObject_ProxyInfo =
    {
    &Object_StubDesc,
    SMSCOM__MIDL_ProcFormatString.Format,
    &IFirstObject_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IFirstObject_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    SMSCOM__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _IFirstObjectProxyVtbl = 
{
    &IFirstObject_ProxyInfo,
    &IID_IFirstObject,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IFirstObject::Default */
};


static const PRPC_STUB_FUNCTION IFirstObject_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IFirstObjectStubVtbl =
{
    &IID_IFirstObject,
    &IFirstObject_ServerInfo,
    8,
    &IFirstObject_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    SMSCOM__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _SMSCOM_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IFirstObjectProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _SMSCOM_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IFirstObjectStubVtbl,
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
...
PCInterfaceName const _SMSCOM_InterfaceNamesList[] = 
{
    "IFirstObject",
    "IComponentRegistrar",
    0
...
const IID *  const _SMSCOM_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _SMSCOM_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SMSCOM, pIID, n)

int __stdcall _SMSCOM_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _SMSCOM, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _SMSCOM, 2, *pIndex )
    
}

const ExtendedProxyFileInfo SMSCOM_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SMSCOM_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SMSCOM_StubVtblList,
    (const PCInterfaceName * ) & _SMSCOM_InterfaceNamesList,
    (const IID ** ) & _SMSCOM_BaseIIDList,
    & _SMSCOM_IID_Lookup, 
    2,
    2,
