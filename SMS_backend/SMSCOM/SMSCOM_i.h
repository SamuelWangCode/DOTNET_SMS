...
#ifndef __SMSCOM_i_h__
#define __SMSCOM_i_h__
...
EXTERN_C const IID IID_IFirstObject;
    ...
    MIDL_INTERFACE("82a55a6d-1422-45c9-88c5-d0dc92937f66")
    IFirstObject : public IDispatch
    {
    public:
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE Default( 
            /* [out] */ BSTR *a1) = 0;
    ...
    typedef struct IFirstObjectVtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *Default )( 
            IFirstObject * This,
            /* [out] */ BSTR *a1);
...
#define IFirstObject_Default(This,a1)	\
    ( (This)->lpVtbl -> Default(This,a1) ) 
...
#ifndef __SMSCOMLib_LIBRARY_DEFINED__
#define __SMSCOMLib_LIBRARY_DEFINED__

/* library SMSCOMLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_SMSCOMLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("005242fa-987d-4c92-8bb7-73d7b5c2a115")
CompReg;
#endif
...
class DECLSPEC_UUID("45da9243-9dfe-4237-af65-8ff4085ed02e")
FirstObject;
#endif
#endif /* __SMSCOMLib_LIBRARY_DEFINED__ */
